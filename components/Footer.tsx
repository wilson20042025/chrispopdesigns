    ...
    return (
        <footer className="bg-sub border-t border-subtle py-16 px-6 md:px-16 transition-colors duration-500">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-24">
                <div className="col-span-1 md:col-span-2 text-center md:text-left">
                    <div className="flex items-center justify-center md:justify-start gap-2 mb-8">
                        <div className="w-10 h-10 bg-primary/10 flex items-center justify-center rounded transition-colors hover:bg-primary/20">
                    ...
                    <p className="text-muted text-xs md:text-sm max-w-sm mx-auto md:mx-0 font-light leading-relaxed">
                        A multi-disciplinary studio specializing in the seamless integration of architectural design and bespoke fabrication.
                    </p>
                </div>
                <div className="text-center md:text-left">
                    ...
                    <ul className="text-muted text-xs md:text-sm space-y-4 font-light">
                        <li className="hover:text-primary transition-colors cursor-pointer">hello@chrispopdesign.studio</li>
            ...
            <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-subtle flex flex-col md:flex-row justify-between items-center gap-6 text-[9px] md:text-[10px] uppercase tracking-widest text-muted text-center md:text-left">
                <span>© 2024 ChrisPopDesign Studio. All rights reserved.</span>
