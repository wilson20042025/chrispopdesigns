        ...
        <div className="font-display bg-base text-content antialiased flex min-h-screen w-full flex-col selection:bg-primary selection:text-white transition-colors duration-500">
            ...
            <main className="flex-1 max-w-7xl mx-auto w-full px-6 md:px-16 py-16 lg:py-24 mt-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                    {projects.map((project, index) => (
                        <Link
                            ...
                            className={`group relative cursor-pointer overflow-hidden aspect-[4/5] bg-sub transition-transform duration-500 hover:shadow-2xl hover:shadow-primary/5 ${project.shifted ? 'lg:translate-y-12' : ''
                                }`}
                        >
                ...
                <div className="mt-48 mb-24 flex justify-center">
                    <button className="group flex items-center gap-4 bg-content text-base hover:bg-primary transition-all duration-500 py-6 px-12 uppercase text-[10px] font-bold tracking-[0.4em] shadow-xl hover:shadow-primary/20">
                        View More Projects
