        ...
        <section className="relative min-h-screen flex items-center justify-center pt-24 px-6 md:px-16 overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-4xl">
            ...
            <div className="flex justify-center">
              <Link href="/projects" className="group flex items-center gap-4 text-[10px] uppercase tracking-[0.3em] font-semibold text-content border-b border-content/20 pb-2 hover:border-primary transition-all">
                View Portfolio
        ...
        <section className="py-24 bg-sub border-y border-subtle transition-colors duration-500">
          <div className="max-w-7xl mx-auto px-6 md:px-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              <div className="group space-y-6 p-8 md:p-10 bg-exp-bg border border-subtle hover:border-primary/50 transition-all duration-500 rounded-xl shadow-2xl">
                ...
                <h3 className="text-lg md:text-xl font-bold uppercase tracking-widest text-exp-content">Architecture</h3>
                <p className="text-exp-muted text-sm md:text-base font-light leading-relaxed">Visionary design solutions tailored for modern landscapes and commercial structures.</p>
              </div>
              <div className="group space-y-6 p-8 md:p-10 bg-exp-bg border border-subtle hover:border-primary/50 transition-all duration-500 rounded-xl shadow-2xl">
                <div className="w-16 h-16 bg-exp-icon-bg flex items-center justify-center rounded-full transition-all duration-500 group-hover:scale-110 shadow-lg">
                ...
                <p className="text-exp-muted text-sm md:text-base font-light leading-relaxed">Advanced manufacturing and craftsmanship in metal, wood, and composite materials.</p>
              </div>
              <div className="group space-y-6 p-8 md:p-10 bg-exp-bg border border-subtle hover:border-primary/50 transition-all duration-500 rounded-xl shadow-2xl">
                <div className="w-16 h-16 bg-exp-icon-bg flex items-center justify-center rounded-full transition-all duration-500 group-hover:scale-110 shadow-lg">
                  <span className="text-exp-icon text-3xl material-symbols-outlined">strategy</span>
                </div>
                <h3 className="text-lg md:text-xl font-bold uppercase tracking-widest text-exp-content">Consulting</h3>
                <p className="text-exp-muted text-sm md:text-base font-light leading-relaxed">Technical oversight and structural analysis for complex engineering challenges.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-base border-b border-subtle transition-colors duration-500" id="projects">
          <div className="max-w-7xl mx-auto px-6 md:px-16">
            ...
            <div className="flex overflow-x-auto pb-12 gap-5 md:gap-6 snap-x no-scrollbar">
              {/* Project 1 */}
              <div className="min-w-[85vw] md:min-w-[400px] snap-start">
                <div className="aspect-video w-full relative rounded-lg overflow-hidden group mb-4 shadow-xl shadow-black/5">
                  <Image
                ...
                <div className="flex justify-between items-start">
                  <div className="max-w-[280px]">
                    <h3 className="text-base md:text-lg font-bold tracking-tight mb-1 uppercase text-content">The Monolith Pavilion</h3>
              ...
              <div className="min-w-[85vw] md:min-w-[400px] snap-start">
                ...
                <div className="flex justify-between items-start">
                  <div className="max-w-[280px]">
                    <h3 className="text-base md:text-lg font-bold tracking-tight mb-1 uppercase text-content">Glass Spine Tower</h3>
              ...
              <div className="min-w-[85vw] md:min-w-[400px] snap-start">
                ...
                <div className="flex justify-between items-start">
                  <div className="max-w-[280px]">
                    <h3 className="text-base md:text-lg font-bold tracking-tight mb-1 uppercase text-content">Kinetic Timber</h3>
              ...
              <div className="min-w-[85vw] md:min-w-[400px] snap-start">
                ...
                <div className="flex justify-between items-start">
                  <div className="max-w-[280px]">
                    <h3 className="text-base md:text-lg font-bold tracking-tight mb-1 uppercase text-content">Neural Steel</h3>
            ...
            <div className="mt-16 flex justify-center">
              <Link href="/projects" className="group flex items-center gap-4 bg-content text-base hover:bg-primary transition-all duration-500 py-5 px-10 rounded uppercase text-[10px] font-bold tracking-[0.4em] shadow-xl hover:shadow-primary/20">
                View All Projects
